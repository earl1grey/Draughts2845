...
import pygame
from .variables import BLACK, ROWS, COLS, WHITE, SQUARE, LIGHT_BLACK, BROWN #Импортирование значений из variables.py общей директории resources.
...
class Board:
    ...
    def move(self, element, row, col): #Движение элемента.
        self.board[element.row][element.col], self.board[row][col] = self.board[row][col], self.board[element.row][element.col] #Изменение позиции элемента перестановкой изначальных значений.
                ...
                for drow in (-1, 1):
                    ...
                    for step in range(1, 8):
                        ...
                        if self.board[r2][c2] == 0:
                            ...
                            count_repeated_enemy = 0
                        elif self.board[r2][c2] == player_color:
                            break
                        elif self.board[r2][c2] != player_color:
